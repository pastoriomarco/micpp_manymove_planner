...
def launch_setup(context, *args, **kwargs):
    ...
    moveit_configs = MoveItConfigsBuilder(
        ...
        file_path=get_package_share_directory("micpp_manymove_planner") + "/config/moveit_cpp.yaml"
    ).to_moveit_configs()

    manymove_planner_node = Node(
        package='micpp_manymove_planner',
        executable='micpp_manymove_planner_node',
        output='screen',
        parameters=[
            moveit_configs.to_dict(),
            {
    ...
    rviz2_node = Node(
        ...
        parameters=[
            {
                'robot_description': moveit_configs.to_dict()['robot_description'],
                'robot_description_semantic': moveit_configs.to_dict()['robot_description_semantic'],
                'robot_description_kinematics': moveit_configs.to_dict()['robot_description_kinematics'],
                'robot_description_planning': moveit_configs.to_dict()['robot_description_planning'],
                'planning_pipelines': moveit_configs.to_dict()['planning_pipelines'],
    ...
    robot_planner_node_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            'moveit_config_dump': moveit_configs.to_dict(),
        }.items(),
    )
